package Module4.AT_HOMENog_een_laatste;
/*Voorzie een ruw systeem waarbinnen boodschappen toegevoegd kunnen worden aan schermen binnen de hogeschool.

De klasse Message bevat een postdatum (die niet meer mag worden aangepast na creatie),
een einddatum en een inhoud. Voorzie de nodige constructors, getters en setters.
