...
/*We gaan hier dieper in op overerving, wat volgt is een complexere hiërarchie waarmee we verschillende
dieren gaan voorstellen, een schema opstellen hoe alles in elkaar past helpt enorm.
Start met een klasse Dier, deze klasse bevat een geboorteDatum, een toString methode en een methode maakGeluid,
maakGeluid geeft tekst terug met het geluid dat een dier maakt. maakGeluid is hier nog te abstract om op te vullen,
dit zal in de subklassen moeten gebeuren.

Vervolgens maak je subklassen van de dieren, we delen Dier op in een klasse Vis, Zoogdier, Vogel, Reptiel en Amfibie.
...
Eens je deze hebt aangemaakt loop je over de arrays en print je van elk dier hier in het resultaat van de maakGeluid
functie af.*/
