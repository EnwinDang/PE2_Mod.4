...
Je kan het jezelf gemakkelijker maken door gebruik te maken van de klasse Cirkel uit de oefeningen
voor Classes, dit helpt voor de berekeningen. Om dit voor te stellen hebben we enkele gegevens nodig:
...
public class Zwembad {
    ...
    private double padBreedte;
    private double padPrijs;
    private double omheiningsPrijs;

    public void Zwembad(double straal, double breedtevanpad, double prijsvanpad, double prijsvanomheining) {
        this.straal = straal;
        this.padBreedte = breedtevanpad;
        this.padPrijs = prijsvanpad;
        this.omheiningsPrijs = prijsvanomheining;
    }
